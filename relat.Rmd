...
Com a Figura \@ref(fig:d1), tem-se que a observação que possui a maior alavancagem é o ponto 262 `r nome[262,1]`, devido ao fato que este pokémon é o que mais achata a Figura.
...
```{r}
#cook(fit1, "Distância do Modelo 1", df) + ggrepel::geom_text_repel(aes(label=1:800), size=2.8, point.padding = 0.3)
```
