...
```{r ref, E, fig.cap = "Frequência de Pokémons Lendários e Não Lendários por Tipo"}
df_dec |> 
...
Uma medida interessante é a matriz de confusão que pode ser vista como uma tabela que possue os valores reais cruzados com os valores preditos, vejamos para os 3 modelos ajustados como a matriz de confusão fica para os dados de teste:
